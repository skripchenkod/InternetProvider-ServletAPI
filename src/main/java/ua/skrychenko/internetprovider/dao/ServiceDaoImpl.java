...
public class ServiceDaoImpl implements ServiceDao {
    ...
    public Map<ServiceEntity, List<TariffEntity>> getAll(String sortBy) {
        ...
        try {
            ...
            String SQL_GET_SERVICE = SQL_GET_ALL_SERVICE;

            if (sortBy != null) {
                SQL_GET_SERVICE += combineQuery(sortBy);
            }

            Statement ps = connection.createStatement();
            ResultSet rs = ps.executeQuery(SQL_GET_SERVICE);
    ...
    private String combineQuery(String query) {
        ...
        } else return " ORDER BY price ASC";
    }
